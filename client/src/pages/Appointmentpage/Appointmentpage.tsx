...
const AppointmentPage: React.FC = () => {
  ...
  return (
      // main container 
      <>
        <div className="p-34 flex flex-row gap-28 "> 
          ...
          <div className="flex flex-col gap-10 w-full p-7 pl-16 pr-16 bg-gray-200 rounded-3xl"> {/* right row */}
            <div className='flex flex-row justify-between p-2'> {/* 1st right col*/}
              <button
                ...
                className=" relative transition-colors border-0 rounded-full bg-amber-50 h-12 w-12"
              ...
              <button
                className="border-0 rounded-full bg-amber-50 h-12 w-12">
                <ChatIcon/>
              </button>
            </div>
